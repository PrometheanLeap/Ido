// PostgreSQL initialization migration — same schema as SQLite, PG-compatible syntax.
// Run once: creates all tables if they don't exist (idempotent via IF NOT EXISTS).
export const pgMigration001 = `
