        ...
        {settingsTab === 'about' && (
          <section className="flex flex-col min-h-[calc(100dvh-11rem)] py-3">
            ...
            <div className="mx-4 mt-3 text-center space-y-1.5 flex-shrink-0">
              <a href="https://github.com/aherbert-pl/Ido" target="_blank" rel="noopener noreferrer" className="text-caption text-primary hover:underline inline-flex items-center gap-1">
